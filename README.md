...
Currently, in Singapore there are around 200,000 FDWs.  They are paid a fixed monthly salary and live in with employers.
Currently, there are more than 600 service providers that help to source these FDWs from neighbouring countries to meet the demand in Singapore.

For families who preferred privacy or do not required a live in maid, they normally opt for Part Time Helper to come in once or twice a week to clean the house.  Part time helper charge 
...
As a User I want to be able to view the profile of all the FDW and interview them over the phone at my premises.
...
FEATURES
==========
Under Home page banner, users can send in their enqiry to all the service providers. Dropdown boxes are provided for user to select according to their specifications. 
Also in Home page, under the "Prefernece section, users can also click on the images on their preferred choice of helpers.
...
youtube tutorials - https://www.youtube.com/watch?v=Zxf1mnP5zcw&t=1355sNearBar
========
